...
const READABILITY_MODE_CSS_VARS: Record<ReadabilityMode, Record<string, string>> = {
    'bright-image': {
        ...
        '--shp-door-window-last-change-bg-muted': 'rgba(255, 255, 255, 0.18)',
        '--shp-door-window-last-change-bg-mid': 'rgba(255, 255, 255, 0.24)',
        '--shp-door-window-last-change-bg-recent': 'rgba(255, 255, 255, 0.3)',
        '--shp-door-window-last-change-bg-alert': 'rgba(180, 48, 48, 0.48)',
        '--shp-door-window-last-change-shadow-muted': 'rgba(255, 255, 255, 0.03)',
        '--shp-door-window-last-change-shadow-mid': 'rgba(255, 255, 255, 0.05)',
        '--shp-door-window-last-change-shadow-recent': 'rgba(255, 255, 255, 0.07)',
        '--shp-door-window-last-change-shadow-alert': 'rgba(200, 60, 60, 0.16)',
        '--shp-motion-last-change-bg-muted': 'rgba(255, 255, 255, 0.2)',
        '--shp-motion-last-change-bg-mid': 'rgba(255, 255, 255, 0.26)',
        '--shp-motion-last-change-bg-recent': 'rgba(255, 255, 255, 0.34)',
        '--shp-motion-last-change-bg-alert': 'rgba(180, 48, 48, 0.5)',
        '--shp-motion-last-change-shadow-muted': 'rgba(255, 255, 255, 0.04)',
        '--shp-motion-last-change-shadow-mid': 'rgba(255, 255, 255, 0.06)',
        '--shp-motion-last-change-shadow-recent': 'rgba(255, 255, 255, 0.09)',
        '--shp-motion-last-change-shadow-alert': 'rgba(200, 60, 60, 0.18)',
    ...
    'dark-image': {
        ...
        '--shp-door-window-last-change-bg-muted': 'rgba(0, 0, 0, 0.26)',
        '--shp-door-window-last-change-bg-mid': 'rgba(0, 0, 0, 0.34)',
        '--shp-door-window-last-change-bg-recent': 'rgba(0, 0, 0, 0.42)',
        '--shp-door-window-last-change-bg-alert': 'rgba(150, 36, 36, 0.48)',
        '--shp-door-window-last-change-shadow-muted': 'rgba(0, 0, 0, 0.12)',
        '--shp-door-window-last-change-shadow-mid': 'rgba(0, 0, 0, 0.18)',
        '--shp-door-window-last-change-shadow-recent': 'rgba(0, 0, 0, 0.24)',
        '--shp-door-window-last-change-shadow-alert': 'rgba(80, 16, 16, 0.22)',
        '--shp-motion-last-change-bg-muted': 'rgba(0, 0, 0, 0.3)',
        '--shp-motion-last-change-bg-mid': 'rgba(0, 0, 0, 0.38)',
        '--shp-motion-last-change-bg-recent': 'rgba(0, 0, 0, 0.46)',
        '--shp-motion-last-change-bg-alert': 'rgba(150, 36, 36, 0.5)',
        '--shp-motion-last-change-shadow-muted': 'rgba(0, 0, 0, 0.14)',
        '--shp-motion-last-change-shadow-mid': 'rgba(0, 0, 0, 0.2)',
        '--shp-motion-last-change-shadow-recent': 'rgba(0, 0, 0, 0.26)',
        '--shp-motion-last-change-shadow-alert': 'rgba(80, 16, 16, 0.24)',
