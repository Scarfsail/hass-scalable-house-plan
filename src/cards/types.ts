...
export interface InfoBoxTypeConfig {
    ...
    overview_active_only?: boolean;  // Default: true for climate, false otherwise - on overview, only show when the entity is "active" (e.g. climate not off), matching plan-placed elements
...
export interface PlanConfig {
    ...
    overview_active_only?: boolean;  // When true, only show on overview if entity is "active" (e.g. light on, climate not off). Default false; defaults to true for climate.
